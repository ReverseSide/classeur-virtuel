...
$requete8 = $bdd->prepare("SELECT *, count(*) AS count_nbabs FROM `t_absence` a LEFT JOIN t_eleve e ON a.idx_eleve=e.id_eleve LEFT JOIN t_classe c ON e.idx_classe=c.id_classe WHERE abs_date < CURDATE() AND c.idx_departement='" . $_GET['dpt'] . "' AND (abs_traite='0' OR abs_traite IS NULL) GROUP BY e.id_eleve HAVING COUNT(*) > 23 ORDER BY `e`.`id_eleve` ASC");
$requete8->execute();
$nbabs24 = $requete8->fetchAll();
    ...
    <div id="page-wrapper">
        ...
        <section class="content" style="min-height: 538px;">
            ...
            <div class="col-xs-12" style="    padding: 0 0 19px 0;">
                <div class="col-lg-12 col-sm-8 col-xs-12 no-padding edusecArLangCss"><h3 class="box-title"><i
                                class="fa fa-th-list"></i> Absences à traiter</h3></div>
            ...
            <div class="box">
                <table class="table table-striped table-bordered table-hover" id="myData">
                    ...
                    foreach ($nbabs24 as $key => $rs) {
                        ...
                        $requete4 = $bdd->prepare("SELECT *, abs_date AS 'dateabs' FROM t_absence AS a LEFT JOIN t_cours ON a.idx_cours=t_cours.id_cours LEFT JOIN t_eleve ON a.idx_eleve=t_eleve.id_eleve LEFT JOIN t_sdh ON a.idx_cours=t_sdh.id_sdh LEFT JOIN t_classe ON a.idx_classe=t_classe.id_classe LEFT JOIN t_horaire ON t_sdh.cou_periode=t_horaire.id_horaire WHERE abs_date < CURDATE() AND a.idx_eleve='" . $rs['id_eleve'] . "' AND (abs_traite='0' OR abs_traite IS NULL) ORDER BY abs_date,ele_nom ASC");
                        $requete4->execute();

                        echo "<td>".$rs['ele_prenom']." ".$rs['ele_nom']."</td><td>".$rs['cla_nom']."</td><td>".$rs['count_nbabs']."</td><td><button id=\"'buttonhidden".$key."'\" type=\"button\" class=\"btn btn-primary buttonShow\" onclick='togl(tablehidden".$key.")' >Tout voir</button></td></tr>";

                        $Absences = $requete4->fetchAll();

                        $Absences_string = "<table id='tablehidden".$key."' class=\"table table-striped table-bordered table-hover\">";
                        foreach ($Absences as $key_absence => $absence) {
                            $Absences_string .=  "<tr><td>Date : " . $absence["abs_date"] . "</td><td> Période : " . $absence["cou_heuredebut"]. "</td></tr>";
                        }
                        $Absences_string .= "</table>";
                        echo "<tr><td colspan=\"4\">".$Absences_string."</td></tr>";
            ...
            <script>
                ...
                function validatec() {
                    ...
                    if (ent == "") {
                        ...
                        document.getElementById("txtlocalentrc").href = mails;
                    ...
                    document.getElementById("hiddenmailsc").value = mail;
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    &nbsp;&nbsp;&nbsp; <a class="btn btn-primary" href="" id="txtlocalentrc"> Local (Copie
                        Entreprise)</a>
                    <br>
                    <br>

                    <form name="frmAddConvocation2" id="frmAddConvocation2" action="./chkForm/chkConvocation.php"
                          method="POST">
                        ...
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="form-group">
                                    ...
                                    <input id="txttitrec" name="txttitrec" class="form-control"
                                           value="<?php echo $titremailc ?>">

                                    <input type="hidden" name='hiddenmailsc' id="hiddenmailsc" value=""
                                           class="form-control">
                                    <input type="hidden" name='hiddenrestec' id="hiddenrestec" value=""
                                           class="form-control">
                                    <input type="hidden" name='hiddenentreprisec' id="hiddenentreprisec" value=""
                                           class="form-control">
                                    <input type="hidden" name='hiddennomc' id="hiddennomc" value=""
                                           class="form-control">
                                    <input type="hidden" name='hiddenidc' id="hiddenidc" value="" class="form-control">
                                    <input type="hidden" name='hiddendatec' id="hiddendatec" value=""
                                           class="form-control">
                                    <input type="hidden" name='hiddenidabsencec' id="hiddenidabsencec" value=""
                                           class="form-control">
                                    <input type="hidden" name='dptc' id="dptc" value="<?php echo $departement; ?>"
                                           class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-8">
                                ...
                                <textarea width="700" height="700" id="txtcorpsc" name="txtcorpsc"
                                          rows="60*60*24"><?php echo $corpsmailc ?></textarea>
                                <br/><br/>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        <label for="cbox3">
                                            Mettre le patron en copie du mail
                                        </label>
                                    </div>
                                    <input type='checkbox' name='ckbcopiepatronc'
                                           value='<?php if (isset($rs['id_eleve'])) echo $rs['id_eleve'] . $rs['abs_date']; ?>."'>
                                    <label for="cbox2">
                        ...
                        <div class="row">
                            <div class="col-xs-8">
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        <label for="cbox3">
                                            Traiter les cas après envoi du mail
                                        </label></div>
                                    <input type='checkbox' name='ckbtraiter'
                                           value='<?php if (isset($rs['id_eleve'])) echo $rs['id_eleve'] . $rs['abs_date']; ?>."'>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form name="frmAddConvocation" id="frmAddConvocation" action="./chkForm/chkmailabsence.php"
                      method="POST">
                    <label for="copiemail">Formulaire d'envoi</label>
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="form-group">
                                ...
                                <input type="hidden" name='hiddenentreprise' id="hiddenentreprise" value=""
                                       class="form-control">
                                ...
                                <input type="hidden" name='hiddenidabsence' id="hiddenidabsence" value=""
                                       class="form-control">
                                <input type="hidden" name='dpt' id="dpt" value="<?php echo $departement; ?>"
                                       class="form-control">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-8">
                            ...
                            <label for="texte">Corps du message : </label>
                            <textarea width="700" height="700" id="txtcorps" name="txtcorps"
                                      rows="60*60*24"><?php echo $corpsmail ?></textarea>
                            <br/><br/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-8">
                            <div class="form-group">
                                <div class="col-xs-6">
                                    <label for="cbox3">
                                        Mettre l'élève en copie du mail
                                    </label>
                                </div>
                                <input type='checkbox' name='ckbcopiepatron'
                                       value='<?php if (isset($rs['id_eleve'])) echo $rs['id_eleve'] . $rs['abs_date']; ?>."'>
                                <label for="cbox2">
                    ...
                    <input type="submit" class="btn btn-danger" id="emailEntrepriseBtn" value="Envoyer"
                           name="frmConSubmit"/>
                </form>
...
<script>
    ...
    $('#frmAddConvocation2').submit(function (e) {
        ...
        $('#modalenvoiMailc').modal('hide');
        $('#modalenvoiMailSent2').modal('show');
        $.ajax({
            type: "POST",
