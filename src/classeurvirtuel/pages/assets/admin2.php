											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover dataTable" aria-describedby="sample-table-2_info">
												<thead>
													<tr role="row">
														...
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 108px;" aria-label="Modèle: activer pour trier">Modèle</th>
														...
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 178px;" aria-label="Stock minimum : activer pour trier">Stock minimum</th>
														...
														<th class="sorting" role="columnheader" tabindex="0" aria-controls="sample-table-2" rowspan="1" colspan="1" style="width: 178px;" aria-label="Lieu : activer pour trier">Lieu</th>
												...
												<tbody role="alert" aria-live="polite" aria-relevant="all">
													<tr class="odd">
														...
														<td class=" "><?php echo $toner[$a]['numModel']; ?></td>
														<td class="hidden-480 "><?php echo $toner[$a]['stock']; ?></td>
														<td class=" "><?php echo $toner[$a]['stockMin'] ?></td>
